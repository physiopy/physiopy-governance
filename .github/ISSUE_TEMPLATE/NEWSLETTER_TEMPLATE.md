...
about: Use this template when organizing the release of a new issue of Physiopy's newsletter
title: '[NEWSLETTER] YYYY.MM.DD'
...
<!--- Feel free to tag any Github users who may be involved in writing each section -->
- [ ] Advertisement of upcoming events (see below)
- [ ] [ADD OTHER CONTENT HERE]

## Advertisement of upcoming events
<!--- Ensure the following items are checked -->
- [ ] Events' dates and times have been confirmed with their moderators
- [ ] Descriptive text has been written for events
